...
public sealed class TestBodyTests(SemanticRuleFixture fixture) : IClassFixture<SemanticRuleFixture>
{
    ...
    public async Task Reports_third_physical_blank_and_first_assertion_before_the_final_blank()
    {
        ...
        Assert.Equal([("DP1001", 12, "", (string?)null), ("DP1002", 9, "A.Equal(1, value)", null)], findings);
    }

    [Theory]
    [InlineData("Xunit.Assert.Throws<System.Exception>((System.Action)(() => throw new System.Exception()));", "")]
    [InlineData("Xunit.Assert.Throws(typeof(System.Exception), (System.Action)(() => throw new System.Exception()));", "")]
    [InlineData("Xunit.Assert.ThrowsAsync<System.Exception>(() => System.Threading.Tasks.Task.FromException(new System.Exception()));", "DP1002")]
    [InlineData("Xunit.Assert.True(true);", "DP1002")]
    [InlineData("Xunit.Assert.Throws<System.Exception>((System.Action)(() => throw new System.Exception())); Xunit.Assert.True(true);", "DP1002")]
    ...
    {
        var project = fixture.Project("class C { [Xunit.Fact] public void Test() {\n \n _ = 1;\n\t\n _ = 2;\n  \n } }");
