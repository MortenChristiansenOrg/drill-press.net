...
public sealed record BundleResponse(int ProtocolVersion, string RequestId, ContextEvaluation[] Contexts, FixBatch[] Batches);
...
public sealed record Finding(string RuleId, string Message, string DocumentId, int Start, int Length, string? BatchId);
...
public sealed record SourceEdit(string FileIdentity, string Fingerprint, int Start, int Length, string OriginalText, string Replacement);
...
public sealed record AggregatedFinding(string RuleId, string Message, string FileIdentity, string Path, int Start, int Length, int Line, int Column, string? BatchId);
...
public sealed record ValidatedResult(AggregatedFinding[] Findings, FixBatch[] Batches, SourceEdit[] Edits);
