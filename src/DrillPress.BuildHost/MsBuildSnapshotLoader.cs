...
public class MsBuildSnapshotLoader
{
    ...
    public virtual async Task<CompilationSnapshot> LoadAsync(string target, SnapshotLoadOptions options, CancellationToken cancellationToken) =>
    ...
    public async Task<SnapshotExport> LoadCompilationsAsync(string target, SnapshotLoadOptions options, CancellationToken cancellationToken = default)
    {
        ...
        var sdk = MSBuildLocator.QueryVisualStudioInstances(new VisualStudioInstanceQueryOptions
        {
