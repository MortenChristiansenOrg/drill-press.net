...
public sealed class CodeNode<TSyntax>(AnalysisSource source, TSyntax syntax) : ICodeElement where TSyntax : SyntaxNode
{
    ...
    public IOperation? Operation => Source.Model.GetOperation(Syntax, Source.Project.CancellationToken);
    ...
    public Optional<object?> Constant => Source.Model.GetConstantValue(Syntax, Source.Project.CancellationToken);
}
