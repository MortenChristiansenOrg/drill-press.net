...
public sealed class ProjectFact<T>(Func<AnalysisProject, T> compute) where T : notnull
{
    ...
    public T In(AnalysisSolution solution, AnalysisProject project)
    {
        ...
        {
            throw new ArgumentException("The project must belong to the supplied solution.", nameof(project));
        }
